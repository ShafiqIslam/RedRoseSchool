<script type="text/javascript">
    $(function () {
        $("#go").on('click', function () {
            ...
            location.href = ROOT+ 'admin/messages/sent/keyword:' + keyword;
        })
    });
</script>
        ...
        <table cellpadding="0" cellspacing="0" class="table">
            ...
            <?php foreach ($messages as $message): ?>
                ...
                <tr style="<?php echo $tr_style;?>">
                    <td style="<?php echo $td_style;?>"><?php echo h($message['Message']['receiver_name']); ?>&nbsp;</td>
                    <td style="<?php echo $td_style;?>"><?php echo h($message['Message']['receiver_phone']); ?>&nbsp;</td>
