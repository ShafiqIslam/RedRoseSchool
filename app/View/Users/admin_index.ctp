...
<div class="index col-md-10 col-sm-10">
    <div class="white">
        ...
        <h2>
            <?php echo __('Users'); ?>
            <?php echo $this->Html->link(__('Add New User'), array('action' => 'add'), array( 'class' => 'btn btn-success', 'style' => 'margin-left:30px')); ?>
        </h2>
            ...
            <?php foreach ($users as $user): ?>
                <tr>
                    ...
                    <td class="actions" style="white-space: nowrap;">
                        ...
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $user['User']['id']), array( 'class' => 'btn btn-info'), __('Deleting a user will also delete associated all data. Are you sure you want to delete %s?', $user['User']['username']));  ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
