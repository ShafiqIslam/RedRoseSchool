    ...
    <div class="white">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                	<?php 
                	if(!empty($this->form->data['Syllabus']['file'])) { ?>
                		<a href="<?php echo $this->webroot.'files/syllabi/'.$this->form->data['Syllabus']['file'];?>" target="_blank"><?php echo $this->form->data['Syllabus']['file'];?></a>
                	<?php } ?>
