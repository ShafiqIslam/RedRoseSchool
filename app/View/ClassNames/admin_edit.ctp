...
<div class="index col-md-10 col-sm-10">
    <div class="white">
        <?php echo $this->Form->create('ClassName',array('class'=>'form-horizontal col-md-6', 'type'=>'file')); ?>
        <fieldset>
            ...
            <div class="form-group">
                <label for="inputEmail3" class="col-sm-3 control-label">Book List</label>
                <div class="col-sm-9">
                    <?php echo $this->Form->input('book_list',array('label' => false,'class'=>'form-control', 'type'=>'file')); ?>
                </div>
            </div>
            <div class="form-group">
