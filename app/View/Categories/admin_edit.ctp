    ...
    <div class="white">
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <button type="button" id="debit_btn" class="btn <?php echo $this->form->data['Category']['debit_credit'] ? 'btn-warning' : 'btn-danger';?>">Debit</button>
                    <button type="button" id="credit_btn" class="btn <?php echo $this->form->data['Category']['debit_credit'] ? 'btn-danger' : 'btn-warning';?>">Credit</button>
                    <?php echo $this->Form->input('debit_credit', array('label' => false,'class'=>'form-control', 'type'=>'hidden', 'value'=>$this->form->data['Category']['debit_credit'])); ?>
                </div>
            </div>
            <div class="form-group">
