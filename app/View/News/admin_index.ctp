<script type="text/javascript">
    $(function () {
        $("#go").on('click', function () {
            ...
            location.href = ROOT+ 'admin/news/index/keyword:' + keyword;
        })
    });
</script>
...
<div class="index col-md-10 col-sm-10">
    <div class="white">
        ...
        <h2>
            <?php echo __('News'); ?>
            <?php echo $this->Html->link(__('Add New News'), array('action' => 'add'), array( 'class' => 'btn btn-success', 'style' => 'margin-left:30px')); ?>
        </h2>
        ...
        <table cellpadding="0" cellspacing="0" class="table">
            ...
            <?php foreach ($news as $item): ?>
                <tr>
                	<td><?php echo h($item['News']['title']); ?>&nbsp;</td>
					<td><?php echo h($item['News']['news']); ?>&nbsp;</td>
                    <td><?php echo date_format(date_create($item['News']['created']), 'd M Y'); ?>&nbsp;</td>
                    <td class="actions" style="white-space: nowrap;">
                        <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $item['News']['id']), array( 'class' => 'btn btn-info')); ?>
                        <?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $item['News']['id']), array( 'class' => 'btn btn-info'), __('Are you sure you want to delete %s?', $item['News']['title']));  ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
